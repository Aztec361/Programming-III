...
public class RedBlackTree<T extends Comparable<T>> {
  ...
  public static boolean test1() {
    ...
    if (tree1.toInOrderString().equals("[ 2, 5, 6, 7, 8, 10, 15 ]")) {
      System.out.println("test1() is true");
      return true;
    }
  ...
  public static boolean test2() { // TODO: Implement this test.
    ...
    if (tree1.toInOrderString().equals("[ 2, 5, 6, 7, 8, 10, 15 ]")) {
      System.out.println("test2() is true");
      return true;
    }
  ...
  public static boolean test3() { // TODO: Implement this test.
    RedBlackTree<Integer> tree1 = new RedBlackTree<Integer>();
    ...
    tree1.rotate(tree1.root.rightChild.rightChild, tree1.root.rightChild);
    System.out.println(tree1.toInOrderString());

    if (tree1.toInOrderString().equals("[ 2, 5, 6, 7, 8, 10, 15, 16 ]")) {
      System.out.println("test3() is true");
      return true;
    }
